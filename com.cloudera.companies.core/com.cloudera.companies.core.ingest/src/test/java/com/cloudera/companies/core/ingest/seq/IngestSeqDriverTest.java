...
public class IngestSeqDriverTest extends CompaniesEmbeddedCoreTestCase {
  ...
  public void testLaunchInvalid() throws Exception {
    ...
    try {
      ...
      Assert.assertEquals(CompaniesDriver.RETURN_FAILURE_MISSING_ARGS, ingestSeqDriver.run(new String[] { inputDir }));
      ...
      Assert.assertEquals(CompaniesDriver.RETURN_FAILURE_INVALID_ARGS,
          ingestSeqDriver.run(new String[] { CompaniesBaseTestCase.getPathLocal(inputNonExistantDir), outputDir }));
