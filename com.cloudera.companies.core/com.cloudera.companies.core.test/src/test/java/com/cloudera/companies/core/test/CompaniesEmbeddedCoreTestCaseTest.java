...
public class CompaniesEmbeddedCoreTestCaseTest extends CompaniesEmbeddedCoreTestCase {
  ...
  public void testMapReduce() throws IOException {
    ...
    Path dirInput = new Path(CompaniesBaseTestCase.getPathHDFS("/tmp/wordcount/input"));
    Path dirOutput = new Path(CompaniesBaseTestCase.getPathHDFS("/tmp/wordcount/output"));
