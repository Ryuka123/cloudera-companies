...
public interface CompaniesBaseTest {
	...
	public static final String PATH_HDFS_OUTPUT_DIR_ZIP = CompaniesBaseTestCase.getPathHDFS("test-ouput/zip");
	public static final String PATH_HDFS_OUTPUT_DIR_SEQ = CompaniesBaseTestCase.getPathHDFS("test-ouput/seq");
